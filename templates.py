...
def list_imdbs():
    ...
    return __sets.keys()
''' # factory.py -> adding imagenet dataset by @bharatsingh430

# TODO
rfcn_sh_template = '''


''' # py-R-FCN-multiGPU/experiments/scripts/rfcn_end2end_ohem_multi_gpu.sh
